<?php
    ...
    if($conn -> query($sql) === TRUE){
        ...
        header("refresh:0; url=http://127.0.0.1/Asesorias_Unicesmag/index.php");
    }else{
        echo "<script> alert('::: USUARIO NO CREADO SATISFACTORIAMENTE :::')</script>";
        header("refresh:0; url=http://127.0.0.1/Asesorias_Unicesmag/front/src/crear_usuarios.html");
    }
?>