...
<body>
    ...
    <form name="edit form" action="http://127.0.0.1/Asesorias_Unicesmag/back/src/cargar_datos_doce.php" method="post">
                ...
                <div class="card card-4">
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <br>               
                            <div class="p-t-15">
                                <center><button class="btn btn--radius-2 btn--blue" type="submit"><a href="http://127.0.0.1/Asesorias_Unicesmag/front/src/home_docente.php">ATRAS</a></button></center>
                            </div>
                        </form>
                    </div>
                </div>
