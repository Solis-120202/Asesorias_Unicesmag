  ...
  <head>
	...
	<section class="ftco-section">
                ...
                while($row = $result -> fetch_assoc()){
                    echo  "<tr>
                            ...
                            <td>
								...
								<a href='http://127.0.0.1/Asesorias_Unicesmag/back/src/borrar_asesoria_doce.php?userId=".$row['id']."'>
        ...
        ?>
			...
			<center>
			<button><a href="http://127.0.0.1/Asesorias_Unicesmag/front/src/home_docente.php">ATRAS</a>
					</button>
			</center>
		</div>
	</section>
