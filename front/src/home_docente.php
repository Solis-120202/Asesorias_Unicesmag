      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="home_docente.php" class="text-white mb-0">UNICESMAG</a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">

              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="../../back/src/listar_asesorias_doce.php"><span>Ver asesorias</span></a></li>
                <li><a href="../../back/src/editar_datos_doce.php"><span>Datos Personales</span></a></li>
