...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="home_estudiante.php" class="text-white mb-0">UNICESMAG</a></h1>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="has-children">
                  <a ><span>Asesoria</span></a>
                  <ul class="dropdown arrow-top">
                    <li><a href="crear_asesoria.php">Registrar </a></li>
                    <li><a href="estado_asesoria.html">Modificar</a></li>
                    <li><a href="estado_asesoria.php">Ver estado</a></li>
                    </li>
                  </ul>
                </li>
                <li><a href="../../back/src/editar_datos_estu.php"><span>Datos Personales</span></a></li>
    ...
    <div class="hero" style="background-image: url('../images/front2.jpeg');">
